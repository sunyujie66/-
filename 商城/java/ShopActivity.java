...
public class ShopActivity extends Activity implements View.OnClickListener{
    ...
    //商品名称与价格数据集合
    private String[] titles = {"草莓蛋糕", "树莓蛋糕", "草莓慕斯", "红丝绒蛋糕", "巧克力蛋糕",
            "甜甜圈", "抹茶蛋糕"};

    private String[] prices = {"30元/份", "35元/份", "38元/份", "38元/份", "25元/份",
            "20元/份", "25元/份"};

    private int[] icons = {R.drawable.caomeicake,R.drawable.shumeicake,R.drawable.caomeimusi,R.drawable.hongsirongcake,R.drawable.qiaokelicake,
            R.drawable.tiantianquan,R.drawable.mochacake};
